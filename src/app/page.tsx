...
export default async function Page(){
 ...
 return <AppShell title="Dashboard" subtitle="Përmbledhja e punës së SIRA Solutions." hidePageHeader>
  <div style={{background:"#dc2626",color:"#fff",padding:"16px",borderRadius:"8px",marginBottom:"16px",fontWeight:700,fontSize:"18px",textAlign:"center"}}>
   TEST DEPLOY — nga Claude, do te hiqet menjehere
  </div>
