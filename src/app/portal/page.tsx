...
export default async function ClientPortalPage() {
  ...
  return <main className="portalPage"><header className="portalHeader"><img src="/sira-logo-black.svg" alt="SIRA Solutions"/><div><span>CLIENT PORTAL</span><strong>{session.name}</strong><PortalLogout /></div></header>
